<?php
namespace MediaMine\Module\Allocine\Entity;
 ...
 * Group Entity.
 *
 * @ORM\Entity(repositoryClass="MediaMine\Module\Allocine\Repository\Common\PersonRepository")
 * @ORM\Table(name="module_allocine_person")
 * @property int $id
