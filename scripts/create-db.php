...
echo exec('java -jar schemaSpy.jar -t pgsql -host localhost:5432 -u postgres -p temporaire -o ../public/db -dp postgresql-9.1-903.jdbc3.jar -db mediamine -s public') . PHP_EOL;